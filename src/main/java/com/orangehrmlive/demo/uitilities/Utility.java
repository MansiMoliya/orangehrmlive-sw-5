package com.orangehrmlive.demo.uitilities;

import com.orangehrmlive.demo.browsefactory.ManageBrowser;
...
//    public List<String> getList(List<WebElement> elementList) {
